...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/blockchaingoldcoin-project/blockchaingoldcoin>";
    const std::string URL_WEBSITE = "<https://blockchaingoldcoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Blockchaingoldcoin version %s\n", FormatFullVersion());
}
