...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s blockchaingoldcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  blockchaingoldcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded blockchaingoldcoin transaction") + "\n" +
              "  blockchaingoldcoin-tx [options] -create [commands]   " + _("Create hex-encoded blockchaingoldcoin transaction") + "\n" +
              "\n";
