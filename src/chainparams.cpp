...
{
    const char* pszTimestamp = "Blockchain GoldCoin (BGC) Development";
    const CScript genesisOutputScript = CScript() << ParseHex("722184710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
      ...
      //  consensus.defaultAssumeValid = uint256S("0x1673fa904a93848eca83d5ca82c7af974511a7e640e22edc2976420744f2e56a"); //1155631
        ...
        genesis = CreateGenesisBlock(1629910419, 2000625853, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x38d2359160468537363fba032193a0fc1de78649eabbd5116187639739aaee66"));
        assert(genesis.hashMerkleRoot == uint256S("0x56a6abf9a1aa0a850f582e957d2f3a3681d109bd6a2a5d2d561d660bbdabd2e8"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("142.93.242.70", "142.93.242.70", true));
       // vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
       // vSeeds.push_back(CDNSSeedData("blockchaingoldcointools.com", "dnsseed.blockchaingoldcointools.com"));
       // vSeeds.push_back(CDNSSeedData("blockchaingoldcoinpool.org", "dnsseed.blockchaingoldcoinpool.org"));
       // vSeeds.push_back(CDNSSeedData("koin-project.com", "dnsseed.koin-project.com"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0x38d2359160468537363fba032193a0fc1de78649eabbd5116187639739aaee66"))
        ...
        chainTxData = ChainTxData{
            ...
            1629910419, // * UNIX timestamp of last known number of transactions
...
public:
    ...
    //    consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nStartTime = 1483228800; // January 1, 2017
     ...
     //   consensus.defaultAssumeValid = uint256S("0x43a16a626ef2ffdbe928f2bc26dcd5475c6a1a04f9542dfc6a0a88e5fcf9bd4c"); //8711
        ...
        genesis = CreateGenesisBlock(1629910419, 2333462, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x927f4b3cbc1afb02941ee77f410dc9e797cda01750a0f3d28bf7cf4816e41c79"));
        assert(genesis.hashMerkleRoot == uint256S("0x56a6abf9a1aa0a850f582e957d2f3a3681d109bd6a2a5d2d561d660bbdabd2e8"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("142.93.242.70", "142.93.242.70"));
       // vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.blockchaingoldcoin.loshan.co.uk", true));
     //   vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed-testnet.thrasher.io", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x927f4b3cbc1afb02941ee77f410dc9e797cda01750a0f3d28bf7cf4816e41c79")),
        };
...
public:
    CRegTestParams() {
     ...
     //   consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nTimeout = 999999999999ULL;
        ...
        genesis = CreateGenesisBlock(1629910419, 2, 0x207fffff, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xc7a845c22ffcbf5cfdbf389f5730856a9392f30c22822e04ab7898d2a3a5ed9a"));
        assert(genesis.hashMerkleRoot == uint256S("0x56a6abf9a1aa0a850f582e957d2f3a3681d109bd6a2a5d2d561d660bbdabd2e8"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0xc7a845c22ffcbf5cfdbf389f5730856a9392f30c22822e04ab7898d2a3a5ed9a"))
        };
