...
{
    const char* pszTimestamp = "BGC Development";
    const CScript genesisOutputScript = CScript() << ParseHex("108584710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
      ...
      //  consensus.defaultAssumeValid = uint256S("0x1673fa904a93848eca83d5ca82c7af974511a7e640e22edc2976420744f2e56a"); //1155631
        ...
        genesis = CreateGenesisBlock(1619122622, 2000008081, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0bac9923ffdd5a9bd1572485a5ee463adc5c2c382d8ad6bfc1e5c53f39ca07c6"));
        assert(genesis.hashMerkleRoot == uint256S("0x59b3864c4a2e204553549c71ba756e5003014a4b95f6f64c2a7e4dacb05d274d"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("51.195.12.180", "51.195.12.180", true));
       ...
       // vSeeds.push_back(CDNSSeedData("koin-project.com", "dnsseed.koin-project.com"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0x0bac9923ffdd5a9bd1572485a5ee463adc5c2c382d8ad6bfc1e5c53f39ca07c6"))
        ...
        chainTxData = ChainTxData{
            ...
            1619122622, // * UNIX timestamp of last known number of transactions
...
public:
    ...
    //    consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nStartTime = 1483228800; // January 1, 2017
     ...
     //   consensus.defaultAssumeValid = uint256S("0x43a16a626ef2ffdbe928f2bc26dcd5475c6a1a04f9542dfc6a0a88e5fcf9bd4c"); //8711
        ...
        genesis = CreateGenesisBlock(1619122622, 158134, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x88802efa14ed42ace5ca2a375e61575af904a8611dfbe2463674451c7f86e17d"));
        assert(genesis.hashMerkleRoot == uint256S("0x59b3864c4a2e204553549c71ba756e5003014a4b95f6f64c2a7e4dacb05d274d"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("51.195.12.180", "51.195.12.180"));
     ...
     //   vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed-testnet.thrasher.io", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x88802efa14ed42ace5ca2a375e61575af904a8611dfbe2463674451c7f86e17d")),
        };
...
public:
    CRegTestParams() {
     ...
     //   consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nTimeout = 999999999999ULL;
        ...
        genesis = CreateGenesisBlock(1619122622, 0, 0x207fffff, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x6c9029178d842569df8d4dac6f24d160fa90fbbd49f8218973e19cc889a0add2"));
        assert(genesis.hashMerkleRoot == uint256S("0x59b3864c4a2e204553549c71ba756e5003014a4b95f6f64c2a7e4dacb05d274d"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x6c9029178d842569df8d4dac6f24d160fa90fbbd49f8218973e19cc889a0add2"))
        };
